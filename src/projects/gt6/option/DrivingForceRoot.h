...
static sKey_L1 = KeyInfo("df_L1", "L1", nil, sActionList, nil);
static sKey_L = KeyInfo("df_L", "L", nil, sActionList, nil);
...
static sKey_R1 = KeyInfo("df_R1", "R1", nil, sActionList, nil);
static sKey_R = KeyInfo("df_R", "R", nil, sActionList, nil);
